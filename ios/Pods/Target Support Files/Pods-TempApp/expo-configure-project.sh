...
with_node \
  ...
  --target "/Users/congyueyue/GirlsFootballApp/ios/Pods/Target Support Files/Pods-TempApp/ExpoModulesProvider.swift" \
   \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-haptics" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-media-library" "expo-router" "expo-secure-store" "expo-sharing" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
